...
\newmdenv[hidealllines=true,leftline=true,linewidth=2pt]{leftframe}
\definecolor{caribbeangreen}{rgb}{0.0, 0.8, 0.6}
\definecolor{cerulean}{rgb}{0.0, 0.48, 0.65}
\definecolor{crimson}{rgb}{0.86, 0.08, 0.24}

\newcommand{\inlinecode}{\texttt}
\newenvironment{anglercode}{
    \VerbatimEnvironment
    \scriptsize
    \linespread{1}
    \begin{leftframe}[skipabove=1cm,leftmargin=1cm,rightmargin=1cm,
                      topline=true,linewidth=0.5pt,linecolor=cerulean,
                      nobreak=true]
    \begin{Verbatim}
}{
    \end{Verbatim}
...
\newcommand{\presentD}{XX\xspace}
\newcommand{\presentM}{Febrero\xspace}
\newcommand{\presentY}{2016\xspace}
...
Ingeniero de Computación}
    \date{Sartenejas, \presentM de \presentY}
\end{titlepage}
