...
\begin{designfr}
Quedamos dudosos acerca de necesidad de comportamientos, tenemos razones a favor:
...
También tenemos razones a favor de usar tipos y constructores:
...
Y en contra de usarlos:

\begin{itemize}
    \item Se prestan a código desordenado.
    \item \#TODO.
\end{itemize}
\end{designfr}
